...
<style> 
  .window-center {top: 50%; /* Отступ в процентах от верхнего края окна */
...
<center>
	<br/>
	<h2>Restricted Area, <b> Access Denied !!! </b></h2>
	<br/>
				<br>
						Framework by <a href="https://instagram.com/alimkh_n" class="font-size: 14px;">Alimkhan Akimzhan</a>.
