...
<tr>
	...
	<td class="line"> 
		<div style="">
			<?php echo $row['question_name'] . ($row['question_type'] == 0 ? ' ( 1 Point )' : ( $row['essay_points'] == 1 ?  '( '. $row['essay_points'] . ' Point )' : '( '. $row['essay_points'] . ' Points )' )   ); ?>
			<a href="javascript:loadPage('index.php?admin/questionedit&question_id='+<?php echo $row['question_id'];?> +'&exam_id='+ <?php echo $row['exam_id']?>);"> Edit</a>
			</div>                             
	</td>
